...
app.post('/api/conversation', async (req, res) => {
    try {
        ...
        // Sort the user IDs to ensure consistency in checking for existing conversations
        const sortedUserIds = [senderId, receiverId].sort();

        // Check if a conversation already exists between the sorted user IDs
        ...
        const newConversation = new Conversations({ members: sortedUserIds });
